...
mixin _$ViewModelState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(FailureV2 failure) error,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(FailureV2 failure)? error,
...
abstract class _Error implements ViewModelState {
  const factory _Error(final FailureV2 failure) = _$ErrorImpl;

  FailureV2 get failure;
  @JsonKey(ignore: true)
  _$$ErrorImplCopyWith<_$ErrorImpl> get copyWith =>
      throw _privateConstructorUsedError;
}
