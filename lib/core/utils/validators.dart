...
import 'package:revbank/core/utils/string_extension.dart';
...
class Validator {
  ...
  //       return "Password must be more than 5 charac ters";
  ...
  static String? nonEmpty(String? input, [String title = "Field"]) {
    if (input != null) {
      if (input.isEmpty) {
  ...
  static String? username(String? name, [String title = "User Name"]) {
    if (name != null) {
      if (name.isEmpty) {
        return "$title cannot be empty";
      } else if (name.length < 2) {
